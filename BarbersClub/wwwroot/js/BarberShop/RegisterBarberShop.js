document.addEventListener('DOMContentLoaded', function () {
    ...
    // --- Lógica de Submissão do Formulário (NOVA LÓGICA) ---
    const form = document.getElementById('registerBarberShopForm');
    if (!form) return; // Encerra se o formulário não for encontrado
    ...
    form.addEventListener('submit', async function (event) {
        ...
        try {
            ...
            // Restaura o botão em qualquer cenário (sucesso ou falha)
            submitButton.disabled = false;
            spinner.classList.add('d-none');
        }
    });
